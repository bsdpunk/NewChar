...
namespace HealerNPC
{
    public class ModEntry : Mod, IAssetEditor, IAssetLoader
    {
        ...
        public void Edit<T>(IAssetData asset)
        {
            ...
            if (asset.AssetNameEquals("Data/NPCDispositions"))
            {
                asset.AsDictionary<string, string>().Data["Kawakami"] = "adult/shy/outgoing/negative/female/non-datable/null/Town/fall 9/Gus 'dad'/Tent 2 3/Kawakami";
            }
        ...
        private void OnGameLaunched(object sender, GameLaunchedEventArgs e)
        {
            ...
            NPC KawakamiNPC = new NPC(null, new Vector2(2, 3), "Tent", 3, "Kawakami", false, null, portrait);
